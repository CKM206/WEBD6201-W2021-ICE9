  ...
  function loadFooter(): void
  {
    ...
    function displayContact(): void
    {
      ...
      formValidation();
        ...
        $("#sendButton").on("click", ()=> 
        {
          ...
          //loadLink("contact"); // This is from before Express
    ...
    function displayContactList(): void
    {
      ...
      if (localStorage.length > 0) 
      {
        ...
        $("button.edit").on("click", function(){
          ...
          //-to the link
          //loadLink("edit", $(this).val().toString()); // THis is from before Express
         ...
         $("button.delete").on("click", function(){
           ...
           //loadLink("contact-list"); // refresh the page // This is from before Express
      ...
      $("#addButton").on("click", function() 
        {
          //console.log("Clicked!")
          //loadLink("edit"); // THis is from before Express
          location.href = '/edit';
    ...
    function displayLogin(): void
    {
      ...
      $("#cancelButton").on("click", function()
      {
        ...
        //loadLink("home"); // This is from before Express
        location.href = '/home';
      });
    }
